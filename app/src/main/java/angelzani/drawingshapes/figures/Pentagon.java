...
public class Pentagon extends Figure {
    ...
    public void drawPentagon(int coordX, int coordY, int diameter, String fillColor, int strokeWidth, String strokeColor) {
    ...
    public void drawShape(int coordX, int coordY, int diameter, String fillColor, int strokeWidth, String strokeColor) {
        this.drawPentagon(coordX, coordY, diameter, fillColor, strokeWidth, strokeColor);
    }
