...
public class Rectangle extends Figure {
    ...
    public void drawRectangle(int coordX, int coordY, int width, int height, String fillColor, int strokeWidth, String strokeColor) {
    ...
    public void drawShape(int coordX, int coordY, int width, int height, String fillColor, int strokeWidth, String strokeColor) {
        this.drawRectangle(coordX, coordY, width, height, fillColor, strokeWidth, strokeColor);
    }
}